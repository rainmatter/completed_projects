# Source: Tomado de: http://www.stedwards.edu/science/baker/help/javamakefile.html


#To use the above makefile to compile your java programs:
#create a file named 'makefile' in your lab directory with the same content as this example
